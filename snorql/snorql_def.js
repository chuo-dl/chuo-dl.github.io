...
//@version 2020-09-23, 2021-02-01 desc_uripats, 2021-02-28 label_union追加, 2021-08-19 proporder, 2021-11-11 hutime, 2021-12-24 jpcos, 2022-08-22 wgs84, 2022-10-14 NDC-LD, 2023-11-15 type_info_props, graph
var Snorqldef = {
	...
	vars: {
		...
		_poweredByLabel: "Chuo Digital Libraries",
		...
		more_ns: {
			...
			"general": "https://jpsearch.go.jp/entity/general/",
	...
	home: {
		...
		graph: {
			...
			pfx: "",	
			num_dpat_par: 1, //number of ()s in datauri_pat -> to be used to set graph_patten 2023-11-15
			pat_sfx: "([^-]+)-"	//regex pattern to append datauri_pat
		},
		...
		//to execute Japan Search specific functions 2023-12-01
		jps_compatible: true
	},
	...
	ldb: {
		...
		dist_props: {
			...
			"schema:workPerformed" : "^%home%entity/",	//any home entity 2023-09-29
		...
		dlink_props: [
			...
			"schema:mainEntityOfPage",	//2022-08-30
			"jps:sourceData",
			"rdfs:seeAlso"
		],
		...
		type_info_props: [
			"schema:url",
			"schema:associatedMedia",
			//use array to specify [parent prop, target prop] 2023-11-15
			["jps:accessInfo","schema:relatedLink"]
		],
		...
		map_pale: "pale.maps.gsi.go.jp", //★setting for JPS (not defined in usual def)
		maps: {
			"openstreetmap.org": {
		...
		//NDC compat test 2022-10-11/14 setup_ldbspecific()でthis.ndcldに	//{uri:"", len:""}に
		ndcld: {
			//"base": "http://jla.or.jp/data/ndc#",
			"no9pat": new RegExp("^http://(id.ndl.go.jp/class/ndc(10|[5-9])?/|jla.or.jp/data/ndc(10|[5-8])?#)([\\d\\.]+)"), 	//exclude ndc9
			"cpos": 4,	//regex match array position
			"v9": "http://jla.or.jp/data/ndc9#"
		},
		//have fun!
